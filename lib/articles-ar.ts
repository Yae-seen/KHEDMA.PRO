...
export const ARTICLES_AR: ArticleMetaAr[] = [
  ...
  },
  {
    ...
    title: "التسجيل في مباراة التعليم بالمغرب: الدليل الكامل خطوة بخطوة",
    description:
      "كيفية التسجيل في مباراة أساتذة أطر الأكاديميات الجهوية: المنصة الرسمية، إنشاء الحساب، الملف، الوثائق، والنافذة السنوية.",
    category: "المباريات",
  },
  {
    slug: "resultats-concours-enseignement",
    title: "نتائج مباراة التعليم بالمغرب: أين وكيف تطّلع عليها",
    description:
      "أين وكيف تطّلع على نتائج مباراة التعليم بالمغرب: الانتقاء الأولي، الناجحون في الكتابي، واللوائح النهائية حسب الأكاديمية الجهوية، مع خطوات ما بعد النتائج.",
    category: "المباريات",
  },
  {
    slug: "preparer-concours-enseignement",
    title: "التحضير لمباراة التعليم: الاختبارات والمنهجية",
    description:
      "كيفية التحضير لمباراة التعليم: بنية الاختبارات، خطة تدريب، مواضيع سابقة ونماذج، ونصائح عملية حسب كل مادة.",
    category: "المباريات",
  },
  {
    slug: "concours-enseignement-prescolaire",
    title: "مباراة التعليم الأولي بالمغرب: الدليل الكامل",
    description:
      "مباراة التعليم الأولي والابتدائي بالمغرب: الفئة المستهدفة، الملامح المطلوبة، الشروط، وكيفية التسجيل والتحضير للمباراة عبر الأكاديميات الجهوية.",
    category: "المباريات",
  },
  {
